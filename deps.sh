...
build_nghttp2() {
  ...
  wget -O- https://github.com/nghttp2/nghttp2/releases/download/v1.69.0/nghttp2-1.69.0.tar.gz | tar xz || exit 1
  cd nghttp2-* || exit 1
...
build_libpsl() {
  ...
  wget -q -O- https://github.com/rockdaboot/libpsl/releases/download/0.22.0/libpsl-0.22.0.tar.gz | tar xz  || exit 1
  cd libpsl-* || exit 1
